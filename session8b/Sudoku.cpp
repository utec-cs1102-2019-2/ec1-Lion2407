...
void cambiazo(MATRIX &matrix){
    int x1,x2,y1,y2;
    int cambio;
    cout << "Digite la primera posición a cambiar: " << endl;
    cout << "Valor de x en el plano: ";
    cin >> x1;
    cout << "Valor de y en el plano: ";
    cin >> y1;

    cout << "Digite la segunda posición a cambiar: " << endl;
    cout << "Valor de x en el plano: ";
    cin >> x2;
    cout << "Valor de y en el plano: ";
    cin >> y2;
